...
import { Col, Row, Card, Image, Button, ListGroup, Tooltip, OverlayTrigger, Nav, Badge } from '@themesberg/react-bootstrap';
...
import "../pages/css/Presentation.css"
...
export default function Navbar() {
  ...
  return (
    <Container state={isNavOpen ? 1 : 0} className="navbarflex">
      <div className="brand">
