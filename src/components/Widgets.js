...
//   const datas={file}
//   axios.put(`http://localhost:3001/auth/update/${authState.id}`,datas)
//   console.log(datas)
//   console.log('hello')
// }
...
//   var filename = Date.now() + filepic.name;

//   info.append("name", filename);
//   info.append("file", filepic);
//   try {
//     axios.post("http://localhost:3001/auth/upload",info);
//   setFile("heelo")
...
//   const file=filename
//   const data={file}
//   axios.put(`http://localhost:3001/auth/update/${authState.id}`,data)
...
setAuthState({username:authState.username,
  status:true,
  role:authState.role,
...
useEffect(()=>{
  axios.get(`http://localhost:3001/auth/getuser/${authState.id}`,{headers:{accessToken:localStorage.getItem("accessToken")},
}).then((response)=>{
...
// console.log(image)
  ...
  return (
    <Card border="light" className="bg-white shadow-sm mb-4">
      ...
      <Button onClick={handleopenwidget}>Upload Profile Picture</Button>
